      ...
      >
        ...
        {apiStatus && (
          <p style={{ fontSize: "14px", color: "#999" }}>
            โหมด:{" "}
            {apiStatus.mode === "online" ? "ออนไลน์" : "ออฟไลน์ (ข้อมูลจำลอง)"}
          </p>
        )}
      </div>
    );
      ...
      {process.env.NODE_ENV === "development" && apiStatus && (
        <div
          style={{
            ...
            border: `1px solid ${
              apiStatus.mode === "online" ? "#c3e6cb" : "#ffeaa7"
            }`,
        ...
        >
          🔧 โหมดพัฒนา: ใช้ข้อมูล
          {apiStatus.mode === "online" ? "จาก API จริง" : "จำลอง (Mock Data)"}
        </div>
      )}
      ...
      >
        ...
        >
          <div className="hero-content">
            ...
            >
              ช้อปสินค้าคุณภาพดี ราคาสุดคุ้ม พร้อมส่งถึงบ้านคุณ
              <br />
            ...
            {[
              {
                icon: "🚚",
                title: "จัดส่งฟรี",
                desc: "จัดส่งฟรีทั่วประเทศ สำหรับยอดซื้อขั้นต่ำ 500 บาท",
              },
              {
                icon: "💳",
                title: "PromptPay",
                desc: "ชำระเงินง่าย รวดเร็ว ปลอดภัย ด้วย QR Code",
              },
              {
                icon: "🔒",
                title: "ปลอดภัย",
                desc: "ระบบการสั่งซื้อที่ปลอดภัย รับประกันความเป็นส่วนตัว",
              },
              {
                icon: "⭐",
                title: "คุณภาพ",
                desc: "สินค้าคุณภาพดี ผ่านการคัดสรรมาอย่างดี",
              },
            ].map((feature, index) => (
              <div
                key={index}
      ...
      >
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "1.1rem", color: "#666" }}>
              สินค้าคุณภาพดีที่เราคัดสรรมาให้คุณโดยเฉพาะ
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "1.1rem", opacity: 0.9 }}>
                สมัครรับข่าวสารเพื่อไม่พลาดโปรโมชั่นดีๆ
              </p>
            </div>
            <form
              ...
              onSubmit={(e) => {
                e.preventDefault();
                alert(
                  "ขอบคุณสำหรับการสมัครรับข่าวสาร! (ฟีเจอร์นี้จะพร้อมใช้งานเร็วๆ นี้)"
                );
              }}
              style={{
                display: "flex",

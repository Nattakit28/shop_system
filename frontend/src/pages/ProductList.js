...
const ProductList = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await productAPI.getProducts(params); // แก้จาก getAll() เป็น getProducts()
      ...
      <div className="container">
        ...
        <div className="page-header">
          ...
          {selectedCategoryData?.description && (
            <p className="page-description">{selectedCategoryData.description}</p>
          )}
        </div>
        ...
        <div className="results-info">
          {!loading && !error && (
            <p>
              ...
              {selectedCategoryData && ` ในหมวดหมู่ "${selectedCategoryData.name}"`}
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Simple Pagination */}
            {pagination.pages > 1 && (
              <div className="simple-pagination" style={{
                display: 'flex',
                ...
                <div className="pagination-info" style={{
                  ...
                  หน้า {pagination.page} จาก {pagination.pages} ({pagination.total} รายการ)
                </div>
